    ...
    <div className="flex h-screen w-full">
        <div className="flex-1 flex overflow-hidden dark:bg-[#651c2b55] bg-[#651c2b] relative justify-center items-center">
            ...
            <div className="flex flex-col gap-2 px-4 xl:ml-40 text-center md:text-start font-semibold">
                <Image src={"/logo.png"} alt='RediStash Logo' width={763} height={173} className="mt-20 w-[420px] z-0 pointer-events-none select-none"/>
        ...
        <div className='flex-1 overflow-hidden relative justify-center items-center hidden md:flex bg-noise'>
        <Image src={"/hero-right.png"} alt='Hero Image' fill className="object-cover dark:opacity-60 pointer-events-none select-none h-full"/>
        </div>
    </div>
  )
}
